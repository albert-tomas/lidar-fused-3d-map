...
def icp_alignment(point_clouds, vis, max_iterations=10, voxel_size=1.0):
    
    # This code adds the point clouds together, but it doesn't align them.
    ...
    for i in range(1, min(len(point_clouds), max_iterations)):
...
def main():
    ...
    point_clouds = load_point_clouds(csv_files, folder_path, max_iterations)
    ...
    icp_alignment(point_clouds, vis, max_iterations, voxel_size)
