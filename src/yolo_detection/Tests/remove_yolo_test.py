...
def create_bev_image(csv_file, output_image_path, res=0.02, x_range=(-20, 20), y_range=(-20, 20), z_range=(-2, 2)):
    # Load data from CSV
...
def create_xy_grid(x_range=(-20, 20), y_range=(-20, 20), step=1.0, z_level=0.0):
    lines = []
    points = []
    # vertical lines
...
def remove_points_in_boxes(csv_path, predictions, output_csv_path, res=0.02, x_range=(-20, 20), y_range=(-20, 20)):
